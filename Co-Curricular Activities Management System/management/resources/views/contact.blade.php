		...
		<header class="header-section">
			...
			<div class="header-warp">
				...
				<ul class="main-menu">
					...
					<li class="active"><a href="{{URL::to('/contact')}}">Developer</a></li>
				</ul>
				...
				<div class="row">
					...
					<div class="col-xl-6 p-0">
						<div class="gallery-single-text">
							...
							<h2>Candle Event Management</h2>
							<ul>
								<li><span>Name:</span>Srabon Bhowmik</li>
								<li><span>ID:</span>161-115-140</li>
								<li><span>Department:</span>CSE</li>
								<li><span>Batch:</span>38 (D)</li>
								<li><span>Email:</span>shanon.cm@gmail.com</li>
							</ul>
